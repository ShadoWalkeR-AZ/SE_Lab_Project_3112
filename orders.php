			  	...
			  	<tbody>
			  		...
			  		for($x = 1; $x < 2; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
                            ...
                            <td style="padding-left:20px; ">
			  					<div class="form-group">
			  					<input type="number" name="return[]" id="return<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="0" />
			  					</div>
			  				</td>

                            <td style="padding-left:20px;">
                                <input type="text" name="sale[]" id="sale<?php echo $x; ?>" autocomplete="off" disabled="true" class="form-control" />
                                <input type="hidden" name="saleValue[]" id="saleValue<?php echo $x; ?>" autocomplete="off" class="form-control" />
                            </td>
...
<!--				  </div>-->
				  ...
				  <div class="form-group">
				    <label for="discount" class="col-sm-3 control-label">Misc. Cost</label>
				    <div class="col-sm-9">
