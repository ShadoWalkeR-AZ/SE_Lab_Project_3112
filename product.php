		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table class="table" id="manageProductTable">
                    ...
                    $sql1 = "SELECT product_name,COUNT(o.product_id) as number FROM order_item o INNER JOIN product p ON o.product_id=p.product_id WHERE order_item_status = 1 GROUP by o.product_id";
                    $sql2 = "SELECT product_name,COUNT(o.product_id) as number FROM order_item o INNER JOIN product p ON o.product_id=p.product_id WHERE order_item_status = 1 GROUP by o.product_id";
                        ...
                        <script type="text/javascript">
                            ...
                            function drawChart()
                            {
                                var data = google.visualization.arrayToDataTable([
                                    ...
                                    {
                                        echo "['".$result1["product_name"]."', ".$result1["number"]."],";
                                    }
                                    ?>
                                    //echo "["123", 12],";
                                ]);
